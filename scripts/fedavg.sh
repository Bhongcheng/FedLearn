...
python main.py --config_path ./config/fedavg.json --dataset_name cifar10 --partition_method lda --partition_alpha 0.6
...
python main.py --config_path ./config/fedavg.json --dataset_name cifar100 --partition_method lda --partition_alpha 0.6